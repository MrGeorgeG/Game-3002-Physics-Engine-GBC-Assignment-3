...
namespace Reality
{
	...
	public:
		...
		{
			glm::vec3 rotationInRads = glm::vec3(glm::radians(eulerAngles.x), glm::radians(eulerAngles.y), glm::radians(eulerAngles.z));
		...
		inline void SetAngX(bool clockwise)
		{
			if (clockwise == true)
			{
				glm::vec3 rad = glm::vec3(glm::radians(0.5f), glm::radians(0.0f), glm::radians(0.0f));
		...
		inline void SetAngY(bool clockwise)
		{
			if (clockwise == true)
			{
				glm::vec3 rad = glm::vec3(glm::radians(0.0f), glm::radians(0.5f), glm::radians(0.0f));
				orientation = glm::quat(rad+glm::eulerAngles(orientation));
			}
		...
		inline void SetAngZ(bool clockwise)
		{
			if (clockwise == true)
			{
				glm::vec3 rad = glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(1.0f));
				orientation = glm::quat(rad + glm::eulerAngles(orientation));
			}
