...
namespace Reality
{
	...
	void ContactResolutionSystem::ResolvePenetration(ContactEvent & contact)
	{
		...
		float linearInertiaA = rbA.reverseQuality;
		...
		float linearInertiaB = rbB.reverseQuality;
	...
	void ContactResolutionSystem::ResolveVelocity(ContactEvent & contact)
	{
		...
		// A
		Vector3 velocityChangeA = impulseA * rbA.reverseQuality;
		...
		// B
		Vector3 velocityChangeB = impulseB * rbB.reverseQuality;
